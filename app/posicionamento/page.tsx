      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <button
            onClick={saveData}
            disabled={saving}
            className="flex items-center space-x-2 px-6 py-2 bg-[#ff901c] text-white rounded-lg hover:shadow-lg transition-all disabled:opacity-50"
          >
        ...
        {[1, 2, 3].map((s) => (
          <button
            ...
            className={`flex-1 py-4 px-6 rounded-lg font-medium transition-all ${
              step === s
                ? "bg-[#ff901c] text-white shadow-lg"
